...
<div class="container"> 
	...
	<form id="join" action="join" method="post" name="formm" class="validation-form" novalidate> 
	<div class="row"> 
	...
	<input type="text" class="form-control" name="nk_name" id="nk_name" placeholder="" value="" required> 
	...
	<input type="email" class="form-control" name="email_id" id="email_id" value="${email_id}" placeholder="you@example.com" required>
	<input type="hidden" name="reid" id="reid" value="${reid}"><br>
	...
	<input type="password" class="form-control" name="pwdCheck" id="pwdCheck" placeholder="" value="" required> 
	</div> 
	</div> 
	
	<div class="mb-3"> 
	<label for="ph_nm">전화번호</label> 
	<input type="text" class="form-control" name="ph_nm" id="ph_nm" value="" placeholder="000-0000-0000" required>
	</div> 
	
	<div class="row"> 
	<div class="mb-3"> 
	<label for="address">주소</label> 
	<input type="text" class="form-control" name="zip_num" id="zip_num" placeholder="우편번호" required><br>
	...
	<div class="row"> 
	<div class="mb-3"> 
	<input type="text" class="form-control" name="addr1" id="addr1" placeholder="도로명주소"> 
	<input type="text" class="form-control" name="addr2" id="addr2" placeholder="지번주소">
	...
	<div class="mb-4"></div> 
	<button class="btn btn-warning btn-lg btn-block" type="submit" onclick="go_save()">가입 하기</button> 
	</form>
	<br>
