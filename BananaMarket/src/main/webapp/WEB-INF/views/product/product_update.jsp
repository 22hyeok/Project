...
<body>
<form class="row g-3" name="frm" id="update_form" method="post" enctype="multipart/form-data">
...
<div class="container">
	...
	<figure class="text-center">
		<h4><p><strong>상품 수정</h4></p></strong>
	</figure>
	<br>
	
	<div class="col-md-6 container-sm">
	    <label for="product_name" class="form-label">상품명</label>
	    <input type="text" class="form-control" name="product_name" id="product_name" value="${productVO.product_name}"><br>
	</div>
	...
	<div class="col-md-6 container-sm">
	    ...
	    <input type="text" class="form-control" name="price" id="price" value="${productVO.price}"><br>
	</div>
	...
	<div class="col-md-6 container-sm">
		  ...
		  <textarea rows="10" class="form-control" name="content" id="content">${productVO.content}</textarea><br>
	</div>
	...
	<div class="col-md-6 container-sm">
		  <button type="submit" class="btn btn-warning btn-lg btn-block" onClick="go_mod_save('${productVO.pd_id}')">수정하기</button>
		  <br>
